    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/60 bg-slate-50/80 backdrop-blur-2xl shadow-[0_4px_30px_rgba(0,0,0,0.03),inset_0_1px_0_rgba(255,255,255,0.8)] transition-all">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-full p-2.5 text-slate-700 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] ring-1 ring-slate-200 transition hover:bg-slate-200/60 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-violet-500 md:hidden bg-white/50"
