...
const WorksHero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full h-[100svh] bg-[#FDFDFD] overflow-hidden flex items-center justify-center perspective-[1500px]"
    >
      {/* -------------------------------------------------------
      ...
      <div className="relative z-10 w-full h-full max-w-[1400px] mx-auto">
        ...
        <div
          className="floating-element absolute top-[5%] left-[10%] md:top-[15%] md:left-[15%] w-[200px] md:w-[280px] h-[120px] md:h-[160px] bg-slate-900/95 backdrop-blur-xl rounded-xl border border-slate-700 shadow-[0_20px_40px_rgba(0,0,0,0.2)] p-4 rotate-[4deg] z-10"
          data-speed="-40"
        >
        ...
        {/* Stat 1: Performance */}
        <div className="absolute top-[35%] right-[10%] md:top-[25%] md:right-[28%] z-40">
          <div className="floating-element rounded-full w-max" data-speed="45">
        ...
        <div className="absolute bottom-[40%] left-[5%] md:bottom-[20%] md:left-[25%] z-40">
          <div className="floating-element rounded-full w-max" data-speed="-35">
            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-xl border border-white shadow-xl rounded-full py-2.5 px-5 w-max hover:scale-110 transition-transform duration-300 ease-out cursor-default">
              <div className="bg-purple-50 text-purple-600 p-2 rounded-full shrink-0">
        ...
        <div className="absolute top-[25%] left-[50%] md:top-[12%] md:left-[45%] -translate-x-1/2 md:-translate-x-0 z-40">
          <div className="floating-element rounded-full w-max" data-speed="50">
            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-xl border border-white shadow-xl rounded-full py-2.5 px-5 w-max hover:scale-110 transition-transform duration-300 ease-out cursor-default">
        ...
        <div className="absolute bottom-[15%] right-[20%] md:bottom-[25%] md:right-[35%] z-40">
          <div className="floating-element rounded-full w-max" data-speed="-55">
            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-xl border border-white shadow-xl rounded-full py-2.5 px-5 w-max hover:scale-110 transition-transform duration-300 ease-out cursor-default">
              <div className="bg-slate-50 text-slate-600 p-2 rounded-full shrink-0">
